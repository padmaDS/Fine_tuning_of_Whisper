...
feature_extractor = WhisperFeatureExtractor.from_pretrained("April01524/cmomay")



processor = WhisperProcessor.from_pretrained("April01524/cmomay", language="Telugu", task="transcribe")
...
tokenizer = WhisperTokenizer.from_pretrained("April01524/cmomay", language="Telugu", task="transcribe")
...
model = WhisperForConditionalGeneration.from_pretrained("April01524/cmomay")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./arthink-small-te",  # change to a repo name of your choice
    per_device_train_batch_size=4, # reducing this to 4 from 16 to avoid OOM errors
    gradient_accumulation_steps=1,  # increase by 2x for every 2x decrease in batch size
    learning_rate=1e-5,
    warmup_steps=20,
    max_steps=20, # reducing this by 10% from the original
